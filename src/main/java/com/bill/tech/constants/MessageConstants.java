...
public final class MessageConstants {
	...
	public static final String BAD_CREDENTIALS = "Your Credentials Are Not Valid !!";
	...
	public static final String DUPLICATE_DATA_ERROR_MSG = "This record already exists in our database !!";
